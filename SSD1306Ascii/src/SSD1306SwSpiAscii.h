 ...
 */
/**
 * @file SSD1306SwSpiAscii.h
 * @brief Class for software SPI displays.
 */
#ifndef SSD1306SwSpiAscii_h
#define SSD1306SwSpiAscii_h

#include "SSD1306Ascii.h"
#include "DigitalOutput.h"
/**
 * @class SSD1306SwSpiAscii
 * @brief Class for SPI displays using software SPI.
 */
class SSD1306SwSpiAscii : public SSD1306Ascii {
 public:
  /**
